export const STEP1_COPY = {
  en: {
    ...
    transparencyCodeRequired: 'Transparency code required. Important: apply Amazon Transparency codes before shipping.',
    transparencyPdfUploaded: 'Transparency PDF uploaded for this SKU.',
    printTransparencyLabels: 'Print Transparency labels',
    noTransparencyPdfUploaded: 'No Transparency PDF uploaded yet.',
    cancel: 'Cancel',
    save: 'Save',
  ...
  ro: {
    ...
    continueToShipping: 'Continuă la expediere',
    ...
    transparencyCodeRequired: 'Cod Transparency obligatoriu. Important: aplică codurile Amazon Transparency înainte de expediere.',
    transparencyPdfUploaded: 'PDF Transparency încărcat pentru acest SKU.',
    printTransparencyLabels: 'Descarcă etichetele Transparency',
    noTransparencyPdfUploaded: 'Nu a fost încărcat încă un PDF Transparency.',
    cancel: 'Anulează',
    save: 'Salvează',
  ...
  fr: {
    ...
    transparencyCodeRequired: 'Code Transparency requis. Important : appliquez les codes Amazon Transparency avant l’expédition.',
    transparencyPdfUploaded: 'PDF Transparency chargé pour ce SKU.',
    printTransparencyLabels: 'Imprimer les étiquettes Transparency',
    noTransparencyPdfUploaded: 'Aucun PDF Transparency chargé pour le moment.',
    cancel: 'Annuler',
    save: 'Enregistrer',
  ...
  de: {
    ...
    transparencyCodeRequired: 'Transparency-Code erforderlich. Wichtig: Amazon-Transparency-Codes vor dem Versand anbringen.',
    transparencyPdfUploaded: 'Transparency-PDF für dieses SKU hochgeladen.',
    printTransparencyLabels: 'Transparency-Etiketten drucken',
    noTransparencyPdfUploaded: 'Noch kein Transparency-PDF hochgeladen.',
    cancel: 'Abbrechen',
    save: 'Speichern',
  ...
  it: {
    ...
    transparencyCodeRequired: 'Codice Transparency obbligatorio. Importante: applica i codici Amazon Transparency prima della spedizione.',
    transparencyPdfUploaded: 'PDF Transparency caricato per questo SKU.',
    printTransparencyLabels: 'Stampa le etichette Transparency',
    noTransparencyPdfUploaded: 'Nessun PDF Transparency caricato.',
  ...
  es: {
    ...
    transparencyCodeRequired: 'Código Transparency obligatorio. Importante: aplica los códigos Amazon Transparency antes del envío.',
    transparencyPdfUploaded: 'PDF Transparency cargado para este SKU.',
    printTransparencyLabels: 'Imprimir etiquetas Transparency',
    noTransparencyPdfUploaded: 'Todavía no se ha cargado un PDF de Transparency.',

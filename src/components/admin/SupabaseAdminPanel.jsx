      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="space-y-3">
            <p className="text-xs uppercase tracking-wide text-text-secondary">Companie</p>
            <div>
              <label className="block text-sm font-medium text-text-primary mb-1">Denumire companie</label>
              <input
                type="text"
          ...
          <div className="space-y-3">
            <p className="text-xs uppercase tracking-wide text-text-secondary">Depozit</p>
            <div>
              <label className="block text-sm font-medium text-text-primary mb-1">Nume hub</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-text-primary mb-1">Adresă</label>
              <textarea
                rows={3}
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="block text-sm font-medium text-text-primary mb-1">Email principal</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-sm font-medium text-text-primary mb-1">Telefon principal</label>
              <input
                type="text"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                placeholder="Stradă, Cod poștal, Țară"
              />
            </div>
          </div>
        </div>

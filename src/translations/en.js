export const en = {
  ...
  euDistributionDesc: 'Strategic hubs in France and Germany for fast shipping to EU fulfillment centers, with everything managed in one platform and kept super simple to operate',

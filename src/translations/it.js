export const it = {
  ...
  authPasswordRequirements: 'Almeno 8 caratteri con maiuscole, minuscole, un numero e un simbolo.',
  ...
  heroTitle: 'Prep Center – hub in Francia e Germania, preparazione e spedizione 24h',
  heroSubtitle: 'Elaborazione in 24h per venditori FBA, FBM, Private Label e Online Arbitrage dai nostri magazzini in Francia e Germania',
  ...
  whyChooseTitle: 'Perché scegliere i nostri hub in Francia e Germania',
  whyChooseSubtitle: 'Servizi professionali di preparazione da due hub UE dedicati ai venditori europei',
  ...
  strategicLocationTitle: 'Posizioni strategiche in Francia e Germania',
  strategicLocationDesc: 'Due hub per distribuzione rapida in tutta l’UE e spedizioni accelerate ai centri di fulfillment',
  ...
  euDistributionDesc: 'Hub strategici in Francia e Germania per spedizioni rapide ai centri di fulfillment europei, con tutto in un’unica piattaforma e super semplice da gestire',
  ...
  qualityCompliance: 'Controllo qualità e conformità (solo verifica visiva)',

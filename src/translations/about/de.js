export const aboutDe = {
  ...
  qualityCompliance: 'Qualität und Compliance (nur visuelle Prüfung)',
  qualityComplianceDesc: 'Rigorose Qualitätskontrolle und volle Compliance mit europäischen Vorschriften.',
  ...
  adrianBio: 'Mit über 4 Jahren praktischer Erfahrung gründete Adrian Prep Center France, um europäischen Verkäufern schnelle, zuverlässige und transparente Prep-Services zu bieten. Sein tiefes Verständnis der Marktplatzanforderungen und europäischen Logistik stellt sicher, dass jedes Produkt nach höchsten Standards vorbereitet wird.',
  linkedinProfile: 'LinkedIn Profil',
  tiktokProfile: 'TikTok Profil',
  
  // CTA Section
  readyPartner: 'Bereit für eine Partnerschaft mit Uns?',
  joinCommunity: 'Treten Sie unserer Gemeinschaft erfolgreicher europäischer E-Commerce-Verkäufer bei und erleben Sie den Unterschied, den professionelle Prep-Services machen können.',

export const aboutIt = {
  // Page Header
  pageTitle: 'Chi Siamo Prep Center France – Servizi di Preparazione Amazon FBA per Venditori Europei',
  pageSubtitle: 'Con oltre 4 anni di esperienza pratica Amazon FBA, Prep Center France fornisce servizi di preparazione veloci e affidabili in Francia: ricezione, controllo qualità, etichettatura FNSKU, imballaggio e spedizione ai centri di fulfillment Amazon in tutta Europa.',
  ...
  qualityComplianceDesc: 'Controllo qualità rigoroso e piena conformità con Amazon FBA e regolamenti europei.',
  ...
  findUsOnGoogle: 'Trovaci su Google',
  googleSearchText: 'Cerca "Prep Center France" su Google per vedere la nostra scheda aziendale verificata e le recensioni dei clienti.',
  adrianBucur: 'Adrian Bucur',
  founderCEO: 'Fondatore e CEO',
  adrianBio: 'Con oltre 4 anni di esperienza pratica Amazon FBA, Adrian ha fondato Prep Center France per fornire ai venditori europei servizi di preparazione veloci, affidabili e trasparenti. La sua profonda comprensione dei requisiti Amazon e della logistica europea garantisce che ogni prodotto sia preparato secondo i più alti standard.',
  linkedinProfile: 'Profilo LinkedIn',
  tiktokProfile: 'Profilo TikTok',
  
  // CTA Section
  readyPartner: 'Pronti a Collaborare con Noi?',
  joinCommunity: 'Unisciti alla nostra comunità di venditori Amazon europei di successo e sperimenta la differenza che possono fare i servizi di preparazione professionale.',
  getStartedToday: 'Inizia Oggi',
  chatWhatsApp: 'Chat WhatsApp',
  
  // Image Alt Text
  warehouseFacilityAlt: 'Struttura Magazzino',
  adrianBucurAlt: 'Adrian Bucur',
  googleSearchResultsAlt: 'Risultati di Ricerca Google per Prep Center France'
};

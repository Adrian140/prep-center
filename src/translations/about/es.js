export const aboutEs = {
  ...
  qualityCompliance: 'Calidad y Cumplimiento (solo verificación visual)',
  ...
  findUsOnGoogle: 'Encuéntranos en Google',
  ...
  // Image Alt Text
  warehouseFacilityAlt: 'Instalación de Almacén',
  adrianBucurAlt: 'Adrian Bucur',
  googleSearchResultsAlt: 'Resultados de Búsqueda Google para Prep Center France'
};

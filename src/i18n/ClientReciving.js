...
export const CLIENT_RECIVING_DICT = {
  ...
  fba_mode_hint: "Ajusta abajo las cantidades para cada producto que quieras enviar directamente.",
  ...
  fba_mode_full: "Send everything to Amazon",
  fba_mode_partial: "Partial shipment",
  fba_mode_hint: "Adjust the quantities below for each product you want to ship directly.",
  fba_mode_available: "Units announced: {qty}",
  fba_mode_summary_full: "Client requested everything to be shipped directly to Amazon.",
